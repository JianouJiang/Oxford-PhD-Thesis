...
\addbibresource{\subfix{./Bibliography/references.bib}}
\graphicspath{{Images}}%
% Suppress paragraph and subsubsection numbering to avoid ().1 format issues
\setcounter{secnumdepth}{2}
% Also reset paragraph counter format
...
\subfile{./texMain/CH1000_Chapter_10.tex}
\subfile{./texMain/CH1050_Code_Availability.tex}
\subfile{./texMain/CH1100_Reference.tex}
\end{document}